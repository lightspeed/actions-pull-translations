...
exports.pullTranslations = (project, resource, languages, mode, branch) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield runShellCommand(`tx pull --mode ${mode} -f -l ${languages.join(',')} -r ${fullResource}`);
});
/**
...
exports.createPullRequest = (project, resource, languages, mode, branch = 'master') => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const response = yield octokit.rest.pulls.create(Object.assign(Object.assign({}, github.context.repo), { head,
            base,
            title,
            body }));
 ...
 */
exports.addAssignee = (pullRequest, addPullerAsAssignee) => __awaiter(void 0, void 0, void 0, function* () {
    if (!addPullerAsAssignee) {
        return;
    }
    const token = process.env.GITHUB_TOKEN;
    const octokit = github.getOctokit(token);
    try {
        yield octokit.rest.issues.addAssignees(Object.assign(Object.assign({}, github.context.repo), { issue_number: pullRequest, assignees: [github.context.actor] }));
    }
    catch (err) {
 ...
 */
exports.requestReviewer = (pullRequest, addPullerAsReviewer) => __awaiter(void 0, void 0, void 0, function* () {
    if (!addPullerAsReviewer) {
        return;
    }
    const token = process.env.GITHUB_TOKEN;
    const octokit = github.getOctokit(token);
    try {
        yield octokit.rest.pulls.requestReviewers(Object.assign(Object.assign({}, github.context.repo), { pull_number: pullRequest, reviewers: [github.context.actor] }));
    }
    catch (err) {
