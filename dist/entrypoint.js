...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { project, resource, languages } = utils_1.extractParamsFromBody(body);
    yield utils_1.pullTranslations(project, resource, languages);
    yield utils_1.pushChangesToRemote(project, resource);
    yield utils_1.createPullRequest(project, resource, languages, number);
