...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { project, resource, languages, mode, branch } = utils_1.extractParamsFromBody(body);
    yield utils_1.pullTranslations(project, resource, languages, mode, branch);
    yield utils_1.pushChangesToRemote(project, resource);
    yield utils_1.createPullRequest(project, resource, languages, mode, number, branch);
